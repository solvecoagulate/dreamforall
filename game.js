...
class MainScene extends Phaser.Scene {
    ...
    create() {
        console.log(this); // Проверка контекста сцены
        ...
        this.physics.add.overlap(this.hero, this.phone, this.interactWithPhone, null, this);
...
const config = {
    ...
    width: 800,
    height: 600,
    scene: MainScene  // Используем класс сцены
};
